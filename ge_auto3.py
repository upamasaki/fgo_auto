...
def story():
    serch_click_image('./img/ge/new.PNG', 0, 0, 1)
    serch_click_image('./img/ge/new2.PNG', 0, 0, 1)
    serch_click_image('./img/ge/omakase.PNG', 0, 0, 1)
    serch_click_image('./img/ge/decide.PNG', 0, 0, 1)
    serch_click_image('./img/ge/decide.PNG', 0, 0, 1)
    serch_click_image('./img/ge/go.PNG', 0, 0, 1)
    serch_click_image('./img/ge/skip.PNG', 0, 0, 1)
    serch_click_image('./img/ge/skip2.PNG', 0, 0, 1)
    serch_click_image2('./img/ge/fullfight.PNG', 0, 0, 1, 0.98)
    serch_click_image('./img/ge/close.PNG', 0, 0, 1)
    serch_click_image('./img/ge/next.PNG', 0, 0, 1)
    serch_click_image('./img/ge/ok.PNG', 0, 0, 1)
    serch_click_image('./img/ge/ok2.PNG', 0, 0, 1)
    #aaa
    print("============>  time.sleep")
